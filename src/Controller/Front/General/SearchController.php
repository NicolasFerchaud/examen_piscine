...
class SearchController extends AbstractController
{
    ...
    {
        // je récupère la valeur du paramètre d'url "search" envoyé depuis le formulaire
        ...
        //je return le tout à ma page search
    ...
    {
        $product = $productRepository->find($id);//récupère un éléments de la table grace à son id (requête native)
